% --------------------------------------------------------------------
% GetDummyDataND   Generate N-dimensional dummy data
% AUTHOR:          Favour Mandanji Nyikosa (favour@robots.ox.ac.uk) 
% DATE:            November 5th, 2013
% UPDATED:         March 29th, 2017
% DEPENDENCIES:    GPML Code Utilities
% --------------------------------------------------------------------
% genertate dummy data based on known Gaussian distribution - Nd
function [x, y, hyp, meta] = getDummyDataND(gpDef, hyp, n_train, N)
