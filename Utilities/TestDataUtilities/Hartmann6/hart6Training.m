...
[xt_, yt_]  = getInitialHart6FunctionData(n_train);
T_          = datetime;         
save(['Hart6_init_', num2str(n_train),'_25_apr_2017_2340'])
...
%% preprocess data
plot_flag   = 0;
[xt, yt, m] = standardizeData(xt_, yt_, 'Hart6 training', plot_flag);
data_meta   = m;
...
%% define test data
plot_flag   = 0;
[xs, ys]    = getInitialHart6FunctionData(n_test);
[xs, ys]    = standardizeData(xs, ys, 'Hart6 test', plot_flag, data_meta);
