...
[xt_, yt_]  = getInitialHart6SCFunctionData(n_train);
T_          = datetime;         
save(['Hart6SC_init_', num2str(n_train),'_25_apr_2017_2330'])
...
%% preprocess data
plot_flag   = 0;
[xt, yt, m] = standardizeData(xt_, yt_, 'Hart6SC training', plot_flag);
data_meta   = m;
