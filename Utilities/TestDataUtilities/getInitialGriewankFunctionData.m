% Gets the initial randomly generated Griewank function.  
%
% Usage:
%
% [X, y] = getInitialGriewankFunctionData(num_points)
%
...
function [X, y] = getInitialGriewankFunctionData(num_points, dim)
