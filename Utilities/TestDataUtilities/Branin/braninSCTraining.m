...
[xt_, yt_]  = getInitialBraninSCFunctionData(n_train);
T_          = datetime;         
save(['braninSC_init_', num2str(n_train),'_25_apr_2017_2310'])
...
%% preprocess data
plot_flag   = 0;
[xt, yt, m] = standardizeData(xt_, yt_, 'BraninSC training', plot_flag);
data_meta   = m;
