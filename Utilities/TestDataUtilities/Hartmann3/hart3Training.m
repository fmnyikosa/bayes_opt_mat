...
[xt_, yt_]  = getInitialHart3FunctionData(n_train);
T_          = datetime;         
save(['Hart3_init_', num2str(n_train),'_25_apr_2017_2325'])
...
%% preprocess data
plot_flag   = 0;
[xt, yt, m] = standardizeData(xt_, yt_, 'Hart3 training', plot_flag);
data_meta   = m;
...
%% define test data
plot_flag   = 0;
[xs, ys]    = getInitialHart3FunctionData(n_test);
[xs, ys]    = standardizeData(xs, ys, 'Hart3 test', plot_flag, data_meta);
