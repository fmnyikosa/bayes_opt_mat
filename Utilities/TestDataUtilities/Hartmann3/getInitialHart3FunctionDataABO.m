% Gets the initial randomly generated 3d data for Hartman 3 function for ABO. 
%
% Usage:
%
% [X, y] = getInitialHart3FunctionDataABO(num_points, max_t)
%
...
function [X, y] = getInitialHart3FunctionDataABO(num_points, max_t)
