% Gets the barometric pressure testing data from Chimet sensors.
...
function [X, y] = getChimetTestingDataBARO()
    data = load('chimet_baro_test');
    X    = data.xte;
    y    = data.yte;
end