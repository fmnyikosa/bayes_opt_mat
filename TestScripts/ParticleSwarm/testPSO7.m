...
tolFunc         = 2e-30;
tolX            = 2e-30;
true_func       = @(x) hart3_func_bulk_glo(x);
...
fun_            = @(x) hart3_func_bulk(x);
OPTS            = calculateOptsSynth3(times,lb_,ub_,num_grid_points,fun_);
...
save('0Hart3PSO.mat', 'gaps', 'traceFunc', 'traceX', 'times', '-v7.3');
