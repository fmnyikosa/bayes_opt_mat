...
tolFunc         = 2e-30;
tolX            = 2e-30;
true_func       = @(x) hart6_sc_func_bulk_glo(x);
...
fun_            = @(x) hart6_sc_func_bulk(x);
OPTS            = calculateOptsSynth6(times,lb_,ub_,num_grid_points,fun_);
...
save('0Hart6SCPSO.mat', 'gaps', 'traceFunc', 'traceX', 'times', '-v7.3');
