...
function settings = getDefaultBOSettingsLCB(x0, iters, settings)
    ...
    settings.acquisitionFunc = 'LCB';      %   Acquisition function handle
    ...
    settings.dimensionality  = length(x0); %   dimensionality of data
    settings.delta           = 0.1;        %   delata from Srinivas paper(2010)
