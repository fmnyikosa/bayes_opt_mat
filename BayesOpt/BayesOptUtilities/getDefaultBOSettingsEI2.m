...
function settings = getDefaultBOSettingsEI2(x0, iters, settings)
    ...
    settings.acquisitionFunc = 'EI2';      %   Acquisition function handle
    settings.minMaxFlag      = 'min';      %   String flag for whether maximizing or minimizing data
    settings.maxObjFuncEvals = 1000;       %   Maximum number of objective function eveluations
    settings.tolObjFunc      = eps^10;     %   Tolerance levels for changes in ObjFunc for termination
    settings.maxAFuncEvals   = 1000;       %   Maximum number of acquisition function eveluations
    settings.tolAFunc        = eps^10;     %   Tolerance levels for changes in AFunc for termination
    settings.tolX            = eps^10;     %   Tolerance levels for changes in input X for termination
    ...
    settings.dimensionality  = length(x0);
    ...
    settings.closePointsMax  =  0; % maximum number of times to tolerate points too close together
