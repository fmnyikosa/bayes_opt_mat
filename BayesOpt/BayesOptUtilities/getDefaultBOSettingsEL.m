...
function settings = getDefaultBOSettingsEL(x0, iters, settings)
    ...
    settings.acquisitionFunc = 'EL';      %   Acquisition function handle
    ...
    settings.tolObjFunc      = eps^3;        %   Tolerance levels for changes in ObjFunc for termination
    settings.maxAFuncEvals   = 1000;       %   Maximum number of acquisition function eveluations
    settings.tolAFunc        = eps^3;        %   Tolerance levels for changes in AFunc for termination
    settings.tolX            = eps^3;        %   Tolerance levels for changes in input X for termination
