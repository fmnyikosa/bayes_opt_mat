function [run_ret all_ret day_ret]=review2_start(fid, data, varargins, opts)
% Copyright by Li Bin, 2011
% Algorithm for Reviewer 2 for ps, start file
% this program demos the market algorithm for portfolio selection
%
%     ra_ret(1, 1) = apy;
%     ra_ret(2, 1) = risk;
%     ra_ret(3, 1) = sr;
...
[run_ret all_ret day_ret]= review2_run(fid, data, tc, opts);
