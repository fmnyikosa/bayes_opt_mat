function [run_ret total_ret day_ret] = ...
    cwmr_var_run_s(fid, data, phi, epsilon, tc, opts)
% Copyright by Li Bin.
...
%% Online 
for t = 1:1:T,
    % Draw a portfolio b_t from N(mu, Sigma) : Stochastic CWMR
    mu_tmp = mvnrnd(mu, sigma);
    % Additional Projection
    day_weight = simplex_projection(mu_tmp', 1);
