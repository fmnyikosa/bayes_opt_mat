% Generated default metadata struct for GP prediction using GPML code. 
%
% Usage:
%
...
%
% Copyright (c) by Favour Mandanji Nyikosa (favour@nyikosa.com), 2017-APRIL-07.


function meta = getDefaultGPMetadataGPML()
    % main GP settings
    ...
    meta.hyp_opt_mode_nres = 10;  % number of restarts
    meta.nit               = 500; % number of iterations for minimize function
