% Generated default metadata struct for GP prediction using mygp code. 
%
% Usage:
%
...
function meta = getDefaultGPMetadataMyGP()
    % main GP settings
    meta.gp_mode           = 0;  % mygp - 0, gpml - 1
    ...
    meta.hyp_opt_mode_nres = 0;  % number of restarts
