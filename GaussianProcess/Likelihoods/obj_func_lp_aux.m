% Auxillary method for calculating negative log predictive probability objective function for Gaussian 
...
% Usage of function:
%
% function [log_prob, dlog_prob] = obj_func_lp_aux(hypx, xt, yt, xs, ys, gpDef)
%
...
function [log_prob] = obj_func_lp_aux(hypx, xt, yt, xs, ys, gpDef)
